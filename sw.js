const CACHE = "labflow-v12";
const ASSETS = ["./", "./index.html", "./styles.css", "./app.js", "./manifest.webmanifest", "./assets/icons/labflow-icon-192.png", "./assets/icons/labflow-icon-512.png"];
